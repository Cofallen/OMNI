...
{
    if (GIMBAL_TARGET[YU_D_MOTOR_GIMBAL_PIT] > 5000)
    {
        GIMBAL_TARGET[YU_D_MOTOR_GIMBAL_PIT] = 5000;
    }
    else if (GIMBAL_TARGET[YU_D_MOTOR_GIMBAL_PIT] < 2000)
    {
        GIMBAL_TARGET[YU_D_MOTOR_GIMBAL_PIT] = 2000;
    }
    ...
    YU_F_CAN_SEND(1,0x2FF, (int16_t)GIMBAL_OUT[YU_D_MOTOR_GIMBAL_YAW], (int16_t)GIMBAL_OUT[YU_D_MOTOR_GIMBAL_PIT], 0, 0);
}