...
void YU_F_GIMBAL(YU_TYPEDEF_MOTOR *MOTOR, YU_TYPEDEF_DBUS *DBUS)
{
    ...
    // PID
    YU_T_PID_CAL(&MOTOR[YU_D_MOTOR_GIMBAL_YAW].PID_A, MOTOR[YU_D_MOTOR_GIMBAL_YAW].DATA.AIM, (float)MOTOR[YU_D_MOTOR_GIMBAL_YAW].DATA.ANGLE_INFINITE);
    ...
    YU_T_PID_CAL(&MOTOR[YU_D_MOTOR_GIMBAL_PIT].PID_A, MOTOR[YU_D_MOTOR_GIMBAL_PIT].DATA.AIM, (float)MOTOR[YU_D_MOTOR_GIMBAL_PIT].DATA.ANGLE_NOW);
